...
function AboutUs() {
  ...
  return (
    <section className="about-us flex">
      <div className="about-us-image flex w-2/5 max-w-[444px] items-center justify-center">
        <img
          src="assets\images\products\hero_image.png"
          className="about-us-image p-10"
        />
      </div>
      <div className="about-us-text w-3/5 ml-3 text-primary-900">
        <h3 className="text-primary-600 text-2xl mb-5">About Us</h3>
        <p>{paragraph}</p>
        <Button className="mt-7 p-4 pt-3 pb-3" text="Learn More" function="" />
      </div>
    </section>
  );
}
