  ...
  return (
    <div className="footer-section flex flex-col items-center w-1/3 mt-10">
      ...
      <div className="flex text-primary-900 flex-col justify-center items-center w-[70%] max-w-[19rem]">
        <input className={`${focus} bg-white w-full rounded-[10px] pr-4 pl-4 border-solid border-[1px] border-primary-400 border-opacity-20 h-10`} />
        <Button text="Sign Up" className="m-5 pt-2 pb-2 pr-4 pl-4" />
      </div>
    </div>
  );
}
